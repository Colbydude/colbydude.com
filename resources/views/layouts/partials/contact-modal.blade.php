<template x-if="contactOpen">
    <div
        ...
        class="modal fade"
        :class="{ 'in show': contactOpen }"
    >
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button @click="contactOpen = false" type="button" class="close">
                ...
                {!! Form::open(['url' => 'contact']) !!}
                    ...
                    <div class="modal-footer">
                        <button @click="contactOpen = false" type="button" class="btn btn-default">Close</button>
