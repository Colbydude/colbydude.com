<footer class="max-w-6xl mx-auto mt-3 px-4 text-slate-600 dark:text-slate-400">
    <div class="flex flex-col-reverse justify-between py-2 border-t-4 border-slate-600 dark:border-slate-400 sm:flex-row">
        ...
        <ul class="flex justify-center items-center pt-1 pb-2 list-none sm:py-0">
            ...
            <li class="px-3"><x-social-link class="hover:text-[#9146ff] dark:hover:text-[#9146ff]" href="http://twitch.tv/Colbydude" title="Twitch" svg="fontawesome/twitch" /></li>
            <li class="px-3"><x-social-link class="hover:text-[#1d9bf0] dark:hover:text-[#1d9bf0]" href="https://twitter.com/Colbydude" title="Twitter" svg="fontawesome/twitter" /></li>
            <li class="pl-3"><x-social-link class="hover:text-[#ff0000] dark:hover:text-[#ff0000]" href="https://www.youtube.com/channel/UCW0IHL6zJWMVjv1ufZS1sCw" title="YouTube" svg="fontawesome/youtube" /></li>
        </ul>
    </div>
</footer>
